...
<template>
  <section id="buy" class="buy section">
    <div class="container">
      <!-- Honest urgency: launch price rising. EDIT the deadline/mechanic to match reality. -->
...
/* Concrete width — the designed cover face has no intrinsic width like an <img>. */
.buy__stage {
  width: 100%;
  max-width: 380px;
  margin: 0 auto;
